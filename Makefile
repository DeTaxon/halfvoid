...
cycle: $(wildcard CompilerReal2/*.cp)
	time ./c.out $(ForcedLibs) CompilerReal2/main.cp -o out3.ll; clang out3.ll $(Libs) -g -debugify -o c.out
repair: $(wildcard CompilerReal2/*.cp) 
	time ./stable $(ForcedLibs) CompilerReal2/main.cp -o out3.ll; clang out3.ll $(Libs) -g -debugify -o c.out
