...
def NormalCheck(CParams,FParams,IsOper = False):
	for i in range(len(CParams)):
		...
		if CParams[i].Type.Type == "class" and FParams[i].Type.Type == "class" and CParams[i].Type.InFamily(FParams[i].Type):
			continue
		if CParams[i].Type.Type == "point" and FParams[i].Type.Type == "point":
			if CParams[i].Type.Base.Type == "class" and FParams[i].Type.Base.Type == "class":
				if CParams[i].Type.Base.InFamily(FParams[i].Type.Base):
					continue
